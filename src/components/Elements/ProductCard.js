...
<div className="w-full mx-2 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg" src="/images/product-1.jpg" alt="product" />
    </Link>
